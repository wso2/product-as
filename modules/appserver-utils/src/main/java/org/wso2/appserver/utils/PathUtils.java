...
public class PathUtils {
     ...
     * @throws ApplicationServerException if neither CATALINA_BASE nor CATALINA_HOME environmental variable has been set
     */
//    public static Path getCatalinaBase() throws ApplicationServerException {
//        String envVariable = System.getProperty(Globals.CATALINA_BASE_PROP);
//        if (envVariable != null) {
//            return Paths.get(envVariable);
//        } else {
//            throw new ApplicationServerException("Neither CATALINA_BASE nor CATALINA_HOME environmental variable has been set");
//        }
//    }
     ...
     * @throws ApplicationServerException if neither CATALINA_BASE nor CATALINA_HOME environmental variable has been set
     */
//    public static Path getCatalinaConfigurationHome() throws ApplicationServerException {
...
//    }
     ...
     * @throws ApplicationServerException if neither CATALINA_BASE nor CATALINA_HOME environmental variable has been set
     */
//    public static Path getWSO2ConfigurationHome() throws ApplicationServerException {
...
//    }
     ...
     * @throws ApplicationServerException if neither CATALINA_BASE nor CATALINA_HOME environmental variable has been set
     */
//    public static Path getWSO2AppServerDescriptor() throws ApplicationServerException {
...
//    }
     ...
     * @throws ApplicationServerException if neither CATALINA_BASE nor CATALINA_HOME environmental variable has been set
     */
//    public static Path getWSO2AppServerDescriptorSchema() throws ApplicationServerException {
...
//    }
     ...
     * @throws ApplicationServerException if neither CATALINA_BASE nor CATALINA_HOME environmental variable has been set
     */
//    public static Path getGlobalWSO2WebAppDescriptor() throws ApplicationServerException {
...
//    }
     ...
     * @throws ApplicationServerException if neither CATALINA_BASE nor CATALINA_HOME environmental variable has been set
     */
//    public static Path getWSO2WebAppDescriptorSchema() throws ApplicationServerException {
...
//    }
     ...
     */
//    public static Path getWSO2WebAppDescriptorForContext(Context context) throws ApplicationServerException {
//        if (context != null) {
...
//    }
     ...
     * @throws ApplicationServerException if the context is null
     */
//    protected static Path getContextRoot(Context context) throws ApplicationServerException {
//        if (context != null) {

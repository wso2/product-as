...
public class ServerClassloadingConfiguration {
    @XmlElement(name = ConfigurationConstants.ClassloadingConstants.WSO2AS_ENVIRONMENTS,
    ...
    public static class Environments {
        @XmlElement(name = ConfigurationConstants.ClassloadingConstants.WSO2AS_ENVIRONMENT,
                namespace = ConfigurationConstants.SERVER_CONFIGURATION_NAMESPACE)
    ...
    public static class Environment {
        @XmlElement(name = ConfigurationConstants.ClassloadingConstants.WSO2AS_ENVIRONMENT_NAME,
                namespace = ConfigurationConstants.SERVER_CONFIGURATION_NAMESPACE)
        private String name;
        @XmlElement(name = ConfigurationConstants.ClassloadingConstants.WSO2AS_CLASSPATH,
                namespace = ConfigurationConstants.SERVER_CONFIGURATION_NAMESPACE)

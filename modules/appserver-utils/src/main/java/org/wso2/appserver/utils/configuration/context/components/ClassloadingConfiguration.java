...
public class ClassloadingConfiguration {
    @XmlElement(name = "environments", namespace = ConfigurationConstants.WEBAPP_DESCRIPTOR_NAMESPACE)
    ...
    public static class Environments {
        @XmlElement(name = "environment", namespace = ConfigurationConstants.WEBAPP_DESCRIPTOR_NAMESPACE)
    ...
    public static class Environment {
        @XmlElement(name = "name", namespace = ConfigurationConstants.WEBAPP_DESCRIPTOR_NAMESPACE)
        private String name;
        @XmlElement(name = "classpath", namespace = ConfigurationConstants.WEBAPP_DESCRIPTOR_NAMESPACE)

...
/**
 * This class sends requests to syntax.jag and validates the response
 */
public class SyntaxObjectTestCase extends ASIntegrationTest {

    private static final Log log = LogFactory.getLog(SyntaxObjectTestCase.class);
    ...
    public SyntaxObjectTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.as"}, description = "Test syntax object")
    public void testApplication() throws Exception {

        String response = null;
        URL jaggeryURL = new URL(getWebAppURL(WebAppTypes.JAGGERY) + "/testapp/syntax.jag");
        ...
        assertEquals(response, "syntax test");
    }
}

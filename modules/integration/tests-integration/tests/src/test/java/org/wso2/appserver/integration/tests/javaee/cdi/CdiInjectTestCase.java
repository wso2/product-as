...
public class CdiInjectTestCase extends ASIntegrationTest {
    ...
    public CdiInjectTestCase(TestUserMode userMode) {
    ...
    @Test(groups = "wso2.as", description = "test cdi inject with servlet")

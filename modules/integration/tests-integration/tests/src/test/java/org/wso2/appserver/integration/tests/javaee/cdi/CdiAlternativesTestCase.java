...
public class CdiAlternativesTestCase extends WebappDeploymentTestCase {

    private static final Log log = LogFactory.getLog(CdiAlternativesTestCase.class);

    private static final String webAppFileName = "cdi-alternatives.war";
    private static final String webAppFilePath = "cdi";
    private static final String webAppName = "cdi-alternatives";
    private static final String webAppLocalURL = "/cdi-alternatives";
    ...
    @Test(groups = "wso2.as", description = "test cdi alternatives with servlet", dependsOnMethods = "webApplicationDeploymentTest")

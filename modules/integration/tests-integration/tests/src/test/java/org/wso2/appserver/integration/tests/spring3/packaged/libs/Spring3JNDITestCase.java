...
package org.wso2.appserver.integration.tests.spring3.packaged.libs;
...
public class Spring3JNDITestCase extends ASIntegrationTest {
    ...
    private String webAppName = "spring3-restful-packaged-libs";
    ...
    public void testSpringWARUpload() throws Exception {
        String springWarFilePath =
                ...
                "spring" + File.separator + "spring3" + File.separator + webAppName + ".war";

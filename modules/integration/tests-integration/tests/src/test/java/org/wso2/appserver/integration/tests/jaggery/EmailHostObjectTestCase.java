...
public class EmailHostObjectTestCase extends ASIntegrationTest {
    ...
    public EmailHostObjectTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.as"},
            description = "Test a sample request and a response for E-mail host object", enabled = false)
    public void testEmailJaggery() throws Exception {

        String response = null;
        URL jaggeryURL = new URL(getWebAppURL(WebAppTypes.JAGGERY) + "/testapp/email.jag");

...
public class CarbonContextApiTestCase extends ASIntegrationTest {
    ...
    public void setEnvironment() throws Exception {
        ...
        if (userMode == TestUserMode.SUPER_TENANT_ADMIN) {
            Path sourcePath = Paths.get(TestConfigurationProvider.getResourceLocation(),
                                        "artifacts", "AS", "carboncontext", "carboncontext-osgi-services.properties");
            Path targetPath = Paths.get(System.getProperty(ServerConstants.CARBON_HOME), "repository", "conf", "etc",

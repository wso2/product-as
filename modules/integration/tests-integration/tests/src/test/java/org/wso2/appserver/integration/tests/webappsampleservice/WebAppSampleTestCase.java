...
public class WebAppSampleTestCase extends ASIntegrationTest {
    ...
    public void testUserManagerAndAuthenticationDemo() throws IOException {
        ...
        String urlTwo = webAppURL + "/example/carbon" + "/authentication/login.jsp?" +
    ...
    public void testRegistryUsageDemo() throws Exception {
        ...
        String urlOne = webAppURL + "/example/carbon" + "/registry/index.jsp?add=" +
        ...
        String urlTwo = webAppURL + "/example/carbon" + "/registry/index.jsp?view" +
    ...
    public void testCarbonCachingDemo() throws Exception {
        ...
        String urlOne = webAppURL + "/example/carbon" + "/caching/index.jsp?add=" +
        ...
        String urlTwo = webAppURL + "/example/carbon" + "/caching/index.jsp?view=" +
                "View&key=" + CACHE_KEY;
        GetMethod getMethodTwo = new GetMethod(urlTwo);
        try {
    ...
    public void testBasicAuth() throws Exception {
        ...
        String pwd = "admin";
        String resourceURL = webAppURL + "/example/jsp/security/protected/index.jsp";

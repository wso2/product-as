...
public class SymlinkToRootCollectionManagementTestCase extends ASIntegrationTest {
    ...
    @Test(groups = "wso2.as", dependsOnMethods = "testAddSymlinkToRootCollection", enabled = true)

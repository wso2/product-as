...
public class MultipleWebAppByUsersTestCase extends ASIntegrationTest {
    ...
    public void testCleanup() throws Exception {
        ...
        super.init(3);//build the environment by user2
        assertTrue(WebApplicationDeploymentUtil.isWebApplicationUnDeployed(
                asServer.getBackEndUrl(), asServer.getSessionCookie(), webAppFileName2),
                   "Webapp has not deployed");

        super.init(4);//build the environment by user2
        assertTrue(WebApplicationDeploymentUtil.isWebApplicationUnDeployed(
                asServer.getBackEndUrl(), asServer.getSessionCookie(), webAppFileName2),
                   "Webapp has not deployed");
    }

 ...
 */
package jaggery.integration.tests.filehostobject;
...
public class FileHostObjectTestCase extends ASIntegrationTest {
    ...
    public void testFileExist() throws Exception {
        ...
        URL jaggeryURL = new URL(asServer.getWebAppURL() + "/testapp/file.jag");
    ...
    public void testFileWrite() throws Exception {
        ...
        String response = null;
        URL jaggeryURL = new URL(asServer.getWebAppURL() + "/testapp/file.jag?action=write");
    ...
    public void testFileOperations() throws Exception {
        ...
        String response = null;
        URL jaggeryURL = new URL(asServer.getWebAppURL() + "/testapp/file.jag?action=test");
        URLConnection jaggeryServerConnection = jaggeryURL.openConnection();
        BufferedReader in = new BufferedReader(new InputStreamReader(
                jaggeryServerConnection.getInputStream()));
    ...
    public void testFileReadChars() throws Exception {
        ...
        String response = null;
        URL jaggeryURL = new URL(asServer.getWebAppURL() + "/testapp/file.jag?action=read");
        URLConnection jaggeryServerConnection = jaggeryURL.openConnection();
        BufferedReader in = new BufferedReader(new InputStreamReader(
                jaggeryServerConnection.getInputStream()));

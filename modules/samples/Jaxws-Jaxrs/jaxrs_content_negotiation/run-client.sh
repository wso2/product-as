...
# update classpath
CLIENT_CLASSPATH=""
for f in "$CARBON_HOME"/samples/Jaxws-Jaxrs/jaxrs_content_negotiation/build/lib/*.jar
do
...
CLIENT_CLASSPATH="$CARBON_HOME/samples/Jaxws-Jaxrs/jaxrs_content_negotiation/build/classes":$CLIENT_CLASSPATH
...
demo.jaxrs.client.Client http://localhost:9763/jaxrs_content_negotiation/services/customers/customerservice$*

...
cd %WSO2AppServer_HOME%\samples\Jaxws-Jaxrs\jaxrs_content_negotiation
...
%_RUNJAVA% %JAVA_OPTS% -Dwso2appserver.home="%WSO2AppServer_HOME%" -cp "%CLIENT_CLASSPATH%" -Djava.endorsed.dirs="%WSO2AppServer_HOME%\lib\endorsed";"%JAVA_HOME%\jre\lib\endorsed";"%JAVA_HOME%\lib\endorsed" demo.jaxrs.client.Client http://localhost:9763/jaxrs_content_negotiation/services/customers/customerservice %*
cd %CURRENT_DIR%
endlocal
:end

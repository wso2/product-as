...
rem ---------------------------------------------------------------------------
rem Client script for the async_jaxws Sample 
rem
...
cd %WSO2AppServer_HOME%\samples\Jaxws-Jaxrs\async_jaxws
...
%_RUNJAVA% %JAVA_OPTS% -Dwso2appserver.home="%WSO2AppServer_HOME%" -cp "%CLIENT_CLASSPATH%" -Djava.endorsed.dirs="%WSO2AppServer_HOME%\lib\endorsed";"%JAVA_HOME%\jre\lib\endorsed";"%JAVA_HOME%\lib\endorsed" demo.hw.client.Client src/main/resources/hello_world_async.wsdl %*
cd %CURRENT_DIR%
endlocal
:end

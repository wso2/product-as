...
for f in "$CARBON_HOME"/samples/EntitlementFilter/temp/dependencies/*.jar
do
...
CLIENT_CLASSPATH="$CARBON_HOME/samples/EntitlementFilter/temp/classes":$CLIENT_CLASSPATH
...
org.wso2.carbon.entitlement.filter.client.Client http://localhost:9763/$*

 ...
 */
public class DeleteAdminUserCommand implements ChadCommand {
    private String username;

    public DeleteAdminUserCommand(String username) {
        this.username = username;
    }

    public void process() throws CommmandExecutionException {
        new ChadPersistenceManager(ChadHibernateConfigFactory.
                getDefaultConfig(ChadConstants.CHAD_HB_CONFIG)).deleteAdminUser(username);
    }
}

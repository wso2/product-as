...
CLIENT_CLASSPATH="$WSO2AppServer_HOME/samples/Trader/temp/classes":"$WSO2AppServer_HOME/samples/Trader/conf":$CLIENT_CLASSPATH
...
org.wso2.appserver.sample.trader.Client $*

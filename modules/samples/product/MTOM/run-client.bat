...
rem
rem   CARBON_HOME      Must point at your WSO2 AppServer directory
rem
...
%_RUNJAVA% %JAVA_OPTS% -Dwso2appserver.home="%CARBON_HOME%" -cp "%CLIENT_CLASSPATH%" -Djava.endorsed.dirs="%CARBON_HOME%\lib\endorsed";"%JAVA_HOME%\jre\lib\endorsed";"%JAVA_HOME%\lib\endorsed" org.wso2.appserver.sample.mtom.client.Client %*
cd %CURRENT_DIR%
endlocal
:end

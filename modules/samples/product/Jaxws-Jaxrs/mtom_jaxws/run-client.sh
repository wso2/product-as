...
for f in "$CARBON_HOME"/samples/Jaxws-Jaxrs/mtom_jaxws/build/lib/*.jar
do
...
CLIENT_CLASSPATH="$CARBON_HOME/samples/Jaxws-Jaxrs/mtom_jaxws/build/classes":$CLIENT_CLASSPATH
...
demo.mtom.client.Client src/main/resources/mtom_xop.wsdl$*

...
for f in "$CARBON_HOME"/samples/Jaxws-Jaxrs/async_jaxws/build/lib/*.jar
do
...
CLIENT_CLASSPATH="$CARBON_HOME/samples/Jaxws-Jaxrs/async_jaxws/build/classes":$CLIENT_CLASSPATH
...
demo.hw.client.Client src/main/resources/hello_world_async.wsdl$*

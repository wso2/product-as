...
CLIENT_CLASSPATH="$WSO2AppServer_HOME/samples/Xfer/tmp/classes":\
"$WSO2AppServer_HOME/samples/tmp/conf":$CLIENT_CLASSPATH
...
org.wso2.appserver.sample.xfer.client.CustomerServiceClient $*

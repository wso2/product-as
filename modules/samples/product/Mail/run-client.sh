...
CLIENT_CLASSPATH="$WSO2AppServer_HOME/samples/Mail/temp/classes":\
"$WSO2AppServer_HOME/samples/Mail/conf":$CLIENT_CLASSPATH
...
org.wso2.appserver.sample.mail.client.MailClient $*

...
CLIENT_CLASSPATH="$WSO2AppServer_HOME/samples/JSON/temp/classes":\
"$WSO2AppServer_HOME/samples/JSON/conf":$CLIENT_CLASSPATH
...
org.wso2.appserver.sample.json.client.JSONClient $*

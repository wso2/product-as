...
CLIENT_CLASSPATH="$WSO2AppServer_HOME/samples/ClientAPI/temp/classes":\
"$WSO2AppServer_HOME/samples/ClientAPI/conf":$CLIENT_CLASSPATH
...
org.wso2.appserver.sample.clientapi.clients.ClientHandler $*

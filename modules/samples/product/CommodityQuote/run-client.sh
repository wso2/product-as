...
CLIENT_CLASSPATH="$WSO2AppServer_HOME/samples/CommodityQuote/temp/classes":\
"$WSO2AppServer_HOME/samples/CommodityQuote/conf":$CLIENT_CLASSPATH
...
org.wso2.appserver.sample.commodityquote.client.Client $*

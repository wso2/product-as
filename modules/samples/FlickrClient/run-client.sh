...
CLIENT_CLASSPATH="$WSO2AppServer_HOME/samples/FlickrClient/temp/classes":\
"$WSO2AppServer_HOME/samples/FlickrClient/conf":$CLIENT_CLASSPATH
...
org.wso2.appserver.sample.flickr.client.Client $*

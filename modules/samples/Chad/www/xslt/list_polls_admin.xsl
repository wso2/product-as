                    ...
                    <td>
						<xsl:choose>
							<xsl:when test="isStopped = 'true'">
								<a>
									<xsl:attribute name="href">#</xsl:attribute>
									<xsl:attribute name="onClick">javascript:wso2.appserver.Chad.static.startPoll('<xsl:value-of select="pollId"/>'); return false;</xsl:attribute>
							...
							<xsl:when test="isStopped = 'false'">
								<a>
									<xsl:attribute name="href">#</xsl:attribute>
									<xsl:attribute name="onClick">javascript:wso2.appserver.Chad.static.stopPoll('<xsl:value-of select="pollId"/>'); return false;</xsl:attribute>

 ...
 */
public class GetPollCommand implements ChadCommand {
    private String pollId;
    private ChadPoll poll;

    public GetPollCommand(String pollId) {
        this.pollId = pollId;
    }

    public void process() throws CommmandExecutionException {
        poll = new ChadPersistenceManager(ChadHibernateConfigFactory.
                getDefaultConfig(ChadConstants.CHAD_HB_CONFIG)).getPoll(pollId);
    }

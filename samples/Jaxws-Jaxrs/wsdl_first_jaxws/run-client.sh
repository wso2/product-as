...
for f in "$CARBON_HOME"/samples/Jaxws-Jaxrs/wsdl_first_jaxws/temp/dependencies/*.jar
do
...
CLIENT_CLASSPATH="$CARBON_HOME/samples/Jaxws-Jaxrs/wsdl_first_jaxws/temp/classes":$CLIENT_CLASSPATH
...
org.example.customerservice.client.CustomerServiceClient src/main/resources/CustomerService.wsdl$*

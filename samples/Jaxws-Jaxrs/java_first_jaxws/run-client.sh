...
for f in "$CARBON_HOME"/samples/Jaxws-Jaxrs/java_first_jaxws/temp/dependencies/*.jar
do
...
CLIENT_CLASSPATH="$CARBON_HOME/samples/Jaxws-Jaxrs/java_first_jaxws/temp/classes":$CLIENT_CLASSPATH
...
demo.hw.client.Client http://localhost:9763/java_first_jaxws/services/hello_world$*

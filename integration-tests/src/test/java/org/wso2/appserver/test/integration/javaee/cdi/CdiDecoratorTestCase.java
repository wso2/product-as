...
public class CdiDecoratorTestCase extends TestBase {
    ...
    public void testCdiServlet() throws IOException {
        ...
        if (responseCodeGet == 200) {
            ...
            Assert.assertTrue(sb.toString().contains("Hi, this is the Receptionist class"),
                    "Response doesn't contain the greeting, of the url");
            Assert.assertTrue(sb.toString().contains("This line is generated by the decorator"),
                    "Response doesn't contain the Decorator, of the url");
        }
    }
}
